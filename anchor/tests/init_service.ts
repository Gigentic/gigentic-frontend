...
describe('Gigentic Service Deployment', () => {
  it('Initializes a service with correct description and price!', async () => {
    ...
    const testDeployerIndex = 0; // Index of the service deployer to be used from the SERVICE_DEPLOYERS array
    const description = 'Test description h'; // Description for the new service to be deployed
