 ...
 * IDL can be found at `target/idl/gigentic_frontend.json`.
 */
export type GigenticFrontend = {
  "address": "6TWkDYVxEiiyVPgX6eg3Rd3N845sPFpWYiUXeneoZXau",
  "metadata": {
    "name": "gigenticFrontend",
    "version": "0.1.0",
    "spec": "0.1.0",
