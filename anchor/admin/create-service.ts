...
const mint: PublicKey = new PublicKey("GZcrawRVdh9mY7aAm7Lt4FbqTNVwYTeVEcFd2SnNCfX6");


export async function createService(program: Program<Gigentic>,price,serviceDescription) {
